(function() {
  ...
  const config = {
  "timestamp": "2025-11-14T00:58:26.207Z",
  "repo": {
    "user": "somiibo",
  ...
  "config": {
    "source": "dist",
    "destination": "/home/runner/work/spotibooster-website/spotibooster-website/_site",
    "collections_dir": "",
    ...
    "meta": {
      "title": "Spotify Bot - Real Streams and Followers - {{ site.brand.name }}",
      "description": "Grow your Spotify presence with our free automation bot. Increase plays, followers, and streams using {{ site.brand.name }}'s powerful Spotify growth tools!",
      "image": "https://cdn.itwcreativeworks.com/assets/somiibo/images/logo/somiibo-brandmark-blue-1024x1024.png",
      "keywords": "",
      "viewport": "",
      "index": true,
      "referrer": ""
    ...
    "brand": {
      "id": "spotibooster",
      "name": "Spotibooster",
      "description": "Grow Spotify plays and followers",
      "type": "Corporation",
      "images": {
    ...
    "cloudflare": {
      "zone": "73dc9b781ad9c7594db865d9e13e58ed"
    },
    "download": {
      "mac": {
        "universal": ""
    ...
    "random_id": 83,
    "canonical": {
      "url": "https://spotibooster.com/config.json",
      "path": "/config.json"
    }
  },
  "npm-build": "2025-11-14T00:58:26.207Z"
};
